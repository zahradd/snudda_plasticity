...
#define ca_ratio_columnindex 8
#define i _p[9]
#define i_columnindex 9
#define ical _p[10]
#define ical_columnindex 10
#define g _p[11]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 tmAmpa tmampa.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "tmampa.mod";
static const char* nmodl_file_text = 
