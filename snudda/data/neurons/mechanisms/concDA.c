...
#define nrn_init _nrn_init__concDA
#define _nrn_initial _nrn_initial__concDA
#define nrn_cur _nrn_cur__concDA
#define _nrn_current _nrn_current__concDA
#define nrn_jacob _nrn_jacob__concDA
#define nrn_state _nrn_state__concDA
#define _net_receive _net_receive__concDA 
#define state state__concDA 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 concDA concDA.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "concDA.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
