...
#define nrn_init _nrn_init__kdr_fs
#define _nrn_initial _nrn_initial__kdr_fs
#define nrn_cur _nrn_cur__kdr_fs
#define _nrn_current _nrn_current__kdr_fs
#define nrn_jacob _nrn_jacob__kdr_fs
#define nrn_state _nrn_state__kdr_fs
#define _net_receive _net_receive__kdr_fs 
#define rates rates__kdr_fs 
#define states states__kdr_fs 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kdr_fs kdr_fs.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "kdr_fs.mod";
static const char* nmodl_file_text = 
