...
#define nrn_init _nrn_init__gGapPar
#define _nrn_initial _nrn_initial__gGapPar
#define nrn_cur _nrn_cur__gGapPar
#define _nrn_current _nrn_current__gGapPar
#define nrn_jacob _nrn_jacob__gGapPar
#define nrn_state _nrn_state__gGapPar
#define _net_receive _net_receive__gGapPar 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "pntproc");
 	...
 	ivoc_help("help ?1 gGapPar par_ggap.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "par_ggap.mod";
static const char* nmodl_file_text = 
  ": ggap.mod\n"
