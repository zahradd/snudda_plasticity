...
#define nrn_init _nrn_init__kdr_ms
#define _nrn_initial _nrn_initial__kdr_ms
#define nrn_cur _nrn_cur__kdr_ms
#define _nrn_current _nrn_current__kdr_ms
#define nrn_jacob _nrn_jacob__kdr_ms
#define nrn_state _nrn_state__kdr_ms
#define _net_receive _net_receive__kdr_ms 
#define rates rates__kdr_ms 
#define states states__kdr_ms 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_kdr_ms", _hoc_setdata,
 "rates_kdr_ms", _hoc_rates,
 0, 0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kdr_ms kdr_ms.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "kdr_ms.mod";
static const char* nmodl_file_text = 
