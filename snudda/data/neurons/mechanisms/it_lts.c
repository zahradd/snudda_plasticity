...
#define nrn_init _nrn_init__it_lts
#define _nrn_initial _nrn_initial__it_lts
#define nrn_cur _nrn_cur__it_lts
#define _nrn_current _nrn_current__it_lts
#define nrn_jacob _nrn_jacob__it_lts
#define nrn_state _nrn_state__it_lts
#define _net_receive _net_receive__it_lts 
#define castate castate__it_lts 
#define evaluate_fct evaluate_fct__it_lts 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_it_lts", _hoc_setdata,
 "evaluate_fct_it_lts", _hoc_evaluate_fct,
 "modulationDA_it_lts", _hoc_modulationDA,
 0, 0
};
#define modulationDA modulationDA_it_lts
 extern double modulationDA( _threadargsproto_ );
 /* declare global and static user variables */
#define q10 q10_it_lts
 double q10 = 3;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 it_lts it_lts.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "it_lts.mod";
static const char* nmodl_file_text = 
