...
#define nrn_init _nrn_init__car_ms
#define _nrn_initial _nrn_initial__car_ms
#define nrn_cur _nrn_cur__car_ms
#define _nrn_current _nrn_current__car_ms
#define nrn_jacob _nrn_jacob__car_ms
#define nrn_state _nrn_state__car_ms
#define _net_receive _net_receive__car_ms 
#define rates rates__car_ms 
#define states states__car_ms 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_car_ms", _hoc_setdata,
 "efun_car_ms", _hoc_efun,
 "ghk_car_ms", _hoc_ghk,
 "modulationDA_car_ms", _hoc_modulationDA,
 "rates_car_ms", _hoc_rates,
 0, 0
};
#define efun efun_car_ms
#define ghk ghk_car_ms
#define modulationDA modulationDA_car_ms
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 car_ms car_ms.mod\n");
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   ica = pbar * m * m * m * h * ghk ( _threadargscomma_ v , cai , cao ) * modulationDA ( _threadargs_ ) ;
   }
 _current += ica;
...
#if NMODL_TEXT
static const char* nmodl_filename = "car_ms.mod";
static const char* nmodl_file_text = 
