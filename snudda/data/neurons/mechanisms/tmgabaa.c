...
#define x _p[22]
#define x_columnindex 22
#define DA _p[23]
#define DA_columnindex 23
#define DB _p[24]
...
extern "C" {
 ...
 static double _hoc_modulationACh(void*);
 static double _hoc_modulationDA(void*);
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 tmGabaA tmgabaa.mod\n");
