...
#define nrn_init _nrn_init__car_fs
#define _nrn_initial _nrn_initial__car_fs
#define nrn_cur _nrn_cur__car_fs
#define _nrn_current _nrn_current__car_fs
#define nrn_jacob _nrn_jacob__car_fs
#define nrn_state _nrn_state__car_fs
#define _net_receive _net_receive__car_fs 
#define rates rates__car_fs 
#define states states__car_fs 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_car_fs", _hoc_setdata,
 "efun_car_fs", _hoc_efun,
 "ghk_car_fs", _hoc_ghk,
 "rates_car_fs", _hoc_rates,
 0, 0
};
#define efun efun_car_fs
#define ghk ghk_car_fs
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 car_fs car_fs.mod\n");
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   ica = pbar * m * m * m * h * ghk ( _threadargscomma_ v , cai , cao ) ;
   }
 _current += ica;
...
#if NMODL_TEXT
static const char* nmodl_filename = "car_fs.mod";
static const char* nmodl_file_text = 
