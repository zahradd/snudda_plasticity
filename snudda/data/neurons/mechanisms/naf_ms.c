...
#define nrn_init _nrn_init__naf_ms
#define _nrn_initial _nrn_initial__naf_ms
#define nrn_cur _nrn_cur__naf_ms
#define _nrn_current _nrn_current__naf_ms
#define nrn_jacob _nrn_jacob__naf_ms
#define nrn_state _nrn_state__naf_ms
#define _net_receive _net_receive__naf_ms 
#define rates rates__naf_ms 
#define states states__naf_ms 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_naf_ms", _hoc_setdata,
 "modulationACh_naf_ms", _hoc_modulationACh,
 "modulationDA_naf_ms", _hoc_modulationDA,
 "rates_naf_ms", _hoc_rates,
 0, 0
};
#define modulationACh modulationACh_naf_ms
#define modulationDA modulationDA_naf_ms
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 naf_ms naf_ms.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "naf_ms.mod";
static const char* nmodl_file_text = 
