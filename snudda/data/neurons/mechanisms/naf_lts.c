...
#define nrn_init _nrn_init__naf_lts
#define _nrn_initial _nrn_initial__naf_lts
#define nrn_cur _nrn_cur__naf_lts
#define _nrn_current _nrn_current__naf_lts
#define nrn_jacob _nrn_jacob__naf_lts
#define nrn_state _nrn_state__naf_lts
#define _net_receive _net_receive__naf_lts 
#define rates rates__naf_lts 
#define states states__naf_lts 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_naf_lts", _hoc_setdata,
 "modulationDA_naf_lts", _hoc_modulationDA,
 "rates_naf_lts", _hoc_rates,
 0, 0
};
#define modulationDA modulationDA_naf_lts
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 naf_lts naf_lts.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "naf_lts.mod";
static const char* nmodl_file_text = 
