...
#define nrn_init _nrn_init__kdr_lts
#define _nrn_initial _nrn_initial__kdr_lts
#define nrn_cur _nrn_cur__kdr_lts
#define _nrn_current _nrn_current__kdr_lts
#define nrn_jacob _nrn_jacob__kdr_lts
#define nrn_state _nrn_state__kdr_lts
#define _net_receive _net_receive__kdr_lts 
#define rates rates__kdr_lts 
#define states states__kdr_lts 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_kdr_lts", _hoc_setdata,
 "modulationDA_kdr_lts", _hoc_modulationDA,
 "rates_kdr_lts", _hoc_rates,
 0, 0
};
#define modulationDA modulationDA_kdr_lts
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kdr_lts kdr_lts.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Fast delayed rectifier potassium current (Kv3.1/3.2)";
...
#if NMODL_TEXT
static const char* nmodl_filename = "kdr_lts.mod";
static const char* nmodl_file_text = 
