...
#define nrn_init _nrn_init__sk_ch
#define _nrn_initial _nrn_initial__sk_ch
#define nrn_cur _nrn_cur__sk_ch
#define _nrn_current _nrn_current__sk_ch
#define nrn_jacob _nrn_jacob__sk_ch
#define nrn_state _nrn_state__sk_ch
#define _net_receive _net_receive__sk_ch 
#define rate rate__sk_ch 
#define state state__sk_ch 
...
#define oinf _p[5]
#define oinf_columnindex 5
#define otau _p[6]
#define otau_columnindex 6
#define Do _p[7]
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_sk_ch", _hoc_setdata,
 "rate_sk_ch", _hoc_rate,
 0, 0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 sk_ch sk_ch.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "SK-type calcium activated K channel (KCa2.2)";
...
#if NMODL_TEXT
static const char* nmodl_filename = "sk_ch.mod";
static const char* nmodl_file_text = 
