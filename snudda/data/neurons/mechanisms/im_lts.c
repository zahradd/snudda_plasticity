...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "modulationACh_im_lts", _hoc_modulationACh,
 "modulationDA_im_lts", _hoc_modulationDA,
 0, 0
};
#define _f_exptable _f_exptable_im_lts
#define exptable exptable_im_lts
#define modulationACh modulationACh_im_lts
#define modulationDA modulationDA_im_lts
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 im_lts im_lts.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "im_lts.mod";
static const char* nmodl_file_text = 
