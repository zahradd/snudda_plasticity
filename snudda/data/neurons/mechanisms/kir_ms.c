...
#define nrn_init _nrn_init__kir_ms
#define _nrn_initial _nrn_initial__kir_ms
#define nrn_cur _nrn_cur__kir_ms
#define _nrn_current _nrn_current__kir_ms
#define nrn_jacob _nrn_jacob__kir_ms
#define nrn_state _nrn_state__kir_ms
#define _net_receive _net_receive__kir_ms 
#define rates rates__kir_ms 
#define states states__kir_ms 
...
#define modDA _p[2]
#define modDA_columnindex 2
#define maxModDA _p[3]
#define maxModDA_columnindex 3
#define levelDA _p[4]
#define levelDA_columnindex 4
#define modACh _p[5]
#define modACh_columnindex 5
#define maxModACh _p[6]
#define maxModACh_columnindex 6
#define levelACh _p[7]
#define levelACh_columnindex 7
#define ik _p[8]
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_kir_ms", _hoc_setdata,
 "modulationACh_kir_ms", _hoc_modulationACh,
 "modulationDA_kir_ms", _hoc_modulationDA,
 "rates_kir_ms", _hoc_rates,
 0, 0
};
#define modulationACh modulationACh_kir_ms
#define modulationDA modulationDA_kir_ms
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kir_ms kir_ms.mod\n");
...
static int  rates ( _threadargsproto_ ) {
   ...
   mtau = 1.0 / ( exp ( ( v - ( - 103.0 ) ) / ( - 14.5 ) ) + 0.125 / ( 1.0 + exp ( ( v - ( - 35.0 ) ) / ( - 19.0 ) ) ) ) ;
     return 0; }
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   gk = gbar * m * modulationDA ( _threadargs_ ) * modulationACh ( _threadargs_ ) ;
   ik = gk * ( v - ek ) ;
   }
 _current += ik;
...
#if NMODL_TEXT
static const char* nmodl_filename = "kir_ms.mod";
static const char* nmodl_file_text = 
