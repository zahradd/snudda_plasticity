...
#define nrn_init _nrn_init__concDAfile
#define _nrn_initial _nrn_initial__concDAfile
#define nrn_cur _nrn_cur__concDAfile
#define _nrn_current _nrn_current__concDAfile
#define nrn_jacob _nrn_jacob__concDAfile
#define nrn_state _nrn_state__concDAfile
#define _net_receive _net_receive__concDAfile 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "pntproc");
 	...
 	ivoc_help("help ?1 concDAfile concDAfile.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "concDAfile.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
