...
#define nrn_init _nrn_init__can_ms
#define _nrn_initial _nrn_initial__can_ms
#define nrn_cur _nrn_cur__can_ms
#define _nrn_current _nrn_current__can_ms
#define nrn_jacob _nrn_jacob__can_ms
#define nrn_state _nrn_state__can_ms
#define _net_receive _net_receive__can_ms 
#define rates rates__can_ms 
#define states states__can_ms 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_can_ms", _hoc_setdata,
 "efun_can_ms", _hoc_efun,
 "ghk_can_ms", _hoc_ghk,
 "modulationACh_can_ms", _hoc_modulationACh,
 "modulationDA_can_ms", _hoc_modulationDA,
 "rates_can_ms", _hoc_rates,
 0, 0
};
#define efun efun_can_ms
#define ghk ghk_can_ms
#define modulationACh modulationACh_can_ms
#define modulationDA modulationDA_can_ms
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 can_ms can_ms.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "can_ms.mod";
static const char* nmodl_file_text = 
