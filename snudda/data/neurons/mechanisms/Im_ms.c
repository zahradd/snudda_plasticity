...
#define nrn_init _nrn_init__Im_ms
#define _nrn_initial _nrn_initial__Im_ms
#define nrn_cur _nrn_cur__Im_ms
#define _nrn_current _nrn_current__Im_ms
#define nrn_jacob _nrn_jacob__Im_ms
#define nrn_state _nrn_state__Im_ms
#define _net_receive _net_receive__Im_ms 
#define rates rates__Im_ms 
#define states states__Im_ms 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_Im_ms", _hoc_setdata,
 "modulationACh_Im_ms", _hoc_modulationACh,
 "rates_Im_ms", _hoc_rates,
 0, 0
};
#define modulationACh modulationACh_Im_ms
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 Im_ms Im_ms.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "Im_ms.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
