...
#define nrn_init _nrn_init__can_fs
#define _nrn_initial _nrn_initial__can_fs
#define nrn_cur _nrn_cur__can_fs
#define _nrn_current _nrn_current__can_fs
#define nrn_jacob _nrn_jacob__can_fs
#define nrn_state _nrn_state__can_fs
#define _net_receive _net_receive__can_fs 
#define rates rates__can_fs 
#define states states__can_fs 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_can_fs", _hoc_setdata,
 "efun_can_fs", _hoc_efun,
 "ghk_can_fs", _hoc_ghk,
 "rates_can_fs", _hoc_rates,
 0, 0
};
#define efun efun_can_fs
#define ghk ghk_can_fs
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 can_fs can_fs.mod\n");
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   ica = pbar * m * m * ( h * a + 1.0 - a ) * ghk ( _threadargscomma_ v , cai , cao ) ;
   }
 _current += ica;
...
#if NMODL_TEXT
static const char* nmodl_filename = "can_fs.mod";
static const char* nmodl_file_text = 
