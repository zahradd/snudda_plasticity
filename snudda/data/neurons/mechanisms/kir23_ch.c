...
#define nrn_init _nrn_init__kir23_ch
#define _nrn_initial _nrn_initial__kir23_ch
#define nrn_cur _nrn_cur__kir23_ch
#define _nrn_current _nrn_current__kir23_ch
#define nrn_jacob _nrn_jacob__kir23_ch
#define nrn_state _nrn_state__kir23_ch
#define _net_receive _net_receive__kir23_ch 
#define rates rates__kir23_ch 
#define states states__kir23_ch 
...
#define modACh _p[1]
#define modACh_columnindex 1
#define maxModACh _p[2]
#define maxModACh_columnindex 2
#define levelACh _p[3]
#define levelACh_columnindex 3
#define ik _p[4]
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_kir23_ch", _hoc_setdata,
 "modulationACh_kir23_ch", _hoc_modulationACh,
 "rates_kir23_ch", _hoc_rates,
 0, 0
};
#define modulationACh modulationACh_kir23_ch
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kir23_ch kir23_ch.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Noninactivating inwardly rectifying potassium current (Kir2.3)";
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   gk = gbar * m * modulationACh ( _threadargs_ ) ;
   ik = gk * ( v - ek ) ;
   }
 _current += ik;
...
#if NMODL_TEXT
static const char* nmodl_filename = "kir23_ch.mod";
static const char* nmodl_file_text = 
