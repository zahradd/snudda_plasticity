...
#define nrn_init _nrn_init__bk_ms
#define _nrn_initial _nrn_initial__bk_ms
#define nrn_cur _nrn_cur__bk_ms
#define _nrn_current _nrn_current__bk_ms
#define nrn_jacob _nrn_jacob__bk_ms
#define nrn_state _nrn_state__bk_ms
#define _net_receive _net_receive__bk_ms 
#define rate rate__bk_ms 
#define state state__bk_ms 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_bk_ms", _hoc_setdata,
 "rate_bk_ms", _hoc_rate,
 0, 0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 bk_ms bk_ms.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "bk_ms.mod";
static const char* nmodl_file_text = 
