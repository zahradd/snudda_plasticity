...
#define nrn_init _nrn_init__concACh
#define _nrn_initial _nrn_initial__concACh
#define nrn_cur _nrn_cur__concACh
#define _nrn_current _nrn_current__concACh
#define nrn_jacob _nrn_jacob__concACh
#define nrn_state _nrn_state__concACh
#define _net_receive _net_receive__concACh 
#define state state__concACh 
...
#define concentration_columnindex 2
#define A _p[3]
...
#define amplitude amplitude_concACh
 double amplitude = 2.5e-05;
 ...
 "amplitude_concACh", &amplitude_concACh,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 concACh concACh.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "concACh.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
