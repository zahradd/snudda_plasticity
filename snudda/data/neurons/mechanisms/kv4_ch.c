...
#define Di5 _p[27]
#define Di5_columnindex 27
#define Dis _p[28]
#define Dis_columnindex 28
#define _g _p[29]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kv4_ch kv4_ch.mod\n");
...
static void _initlists() {
 int _i; static int _first = 1;
  if (!_first) return;
 _slist1[0] = is_columnindex;  _dlist1[0] = Dis_columnindex;
 ...
 _slist1[10] = o_columnindex;  _dlist1[10] = Do_columnindex;
_first = 0;
}
