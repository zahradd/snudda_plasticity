...
#define nrn_init _nrn_init__kaf_lts
#define _nrn_initial _nrn_initial__kaf_lts
#define nrn_cur _nrn_cur__kaf_lts
#define _nrn_current _nrn_current__kaf_lts
#define nrn_jacob _nrn_jacob__kaf_lts
#define nrn_state _nrn_state__kaf_lts
#define _net_receive _net_receive__kaf_lts 
#define rates rates__kaf_lts 
#define states states__kaf_lts 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_kaf_lts", _hoc_setdata,
 "modulationDA_kaf_lts", _hoc_modulationDA,
 "rates_kaf_lts", _hoc_rates,
 0, 0
};
#define modulationDA modulationDA_kaf_lts
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kaf_lts kaf_lts.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "kaf_lts.mod";
static const char* nmodl_file_text = 
