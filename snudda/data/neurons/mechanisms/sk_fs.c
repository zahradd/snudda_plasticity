...
#define nrn_init _nrn_init__sk_fs
#define _nrn_initial _nrn_initial__sk_fs
#define nrn_cur _nrn_cur__sk_fs
#define _nrn_current _nrn_current__sk_fs
#define nrn_jacob _nrn_jacob__sk_fs
#define nrn_state _nrn_state__sk_fs
#define _net_receive _net_receive__sk_fs 
#define rate rate__sk_fs 
#define state state__sk_fs 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_sk_fs", _hoc_setdata,
 "rate_sk_fs", _hoc_rate,
 0, 0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 sk_fs sk_fs.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "sk_fs.mod";
static const char* nmodl_file_text = 
