...
#define modDA _p[3]
#define modDA_columnindex 3
#define maxModDA _p[4]
#define maxModDA_columnindex 4
#define levelDA _p[5]
#define levelDA_columnindex 5
#define ina _p[6]
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "modulationDA_na3_lts", _hoc_modulationDA,
...
#define modulationDA modulationDA_na3_lts
...
#define hmin hmin_na3_lts
 double hmin = 0.5;
#define htau htau_na3_lts
 double htau = 0;
#define hinf hinf_na3_lts
 double hinf = 0;
#define mmin mmin_na3_lts
 double mmin = 0.02;
#define mtau mtau_na3_lts
 double mtau = 0;
#define minf minf_na3_lts
 double minf = 0;
...
#define qa qa_na3_lts
 double qa = 7.2;
#define qinf qinf_na3_lts
 double qinf = 4;
#define smax smax_na3_lts
 double smax = 10;
#define sinf sinf_na3_lts
 double sinf = 0;
...
#define tha tha_na3_lts
 double tha = -30;
#define thinf thinf_na3_lts
 double thinf = -50;
#define taus taus_na3_lts
 double taus = 0;
...
#define zetas zetas_na3_lts
 ...
 "thinf_na3_lts", &thinf_na3_lts,
 "qinf_na3_lts", &qinf_na3_lts,
 ...
 "minf_na3_lts", &minf_na3_lts,
 "hinf_na3_lts", &hinf_na3_lts,
 "mtau_na3_lts", &mtau_na3_lts,
 "htau_na3_lts", &htau_na3_lts,
 "sinf_na3_lts", &sinf_na3_lts,
 "taus_na3_lts", &taus_na3_lts,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 na3_lts na3_lts.mod\n");
...
static double _nrn_current(double _v){double _current=0.;v=_v;{ {
   thegna = gbar * m * m * m * h * s * modulationDA ( _threadargs_ ) ;
   ina = thegna * ( v - ena ) ;
   }
 _current += ina;
 ...
 v=_v;
{
  ena = _ion_ena;
 { error =  states();
 if(error){fprintf(stderr,"at line 102 in file na3_lts.mod:\n    SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "na3_lts.mod";
static const char* nmodl_file_text = 
  "TITLE na3\n"
  ": Na current \n"
