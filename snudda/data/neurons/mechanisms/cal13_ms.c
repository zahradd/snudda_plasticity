...
#define nrn_init _nrn_init__cal13_ms
#define _nrn_initial _nrn_initial__cal13_ms
#define nrn_cur _nrn_cur__cal13_ms
#define _nrn_current _nrn_current__cal13_ms
#define nrn_jacob _nrn_jacob__cal13_ms
#define nrn_state _nrn_state__cal13_ms
#define _net_receive _net_receive__cal13_ms 
#define rates rates__cal13_ms 
#define states states__cal13_ms 
...
#define modACh _p[4]
#define modACh_columnindex 4
#define maxModACh _p[5]
#define maxModACh_columnindex 5
#define levelACh _p[6]
#define levelACh_columnindex 6
#define ical _p[7]
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_cal13_ms", _hoc_setdata,
 "efun_cal13_ms", _hoc_efun,
 "ghk_cal13_ms", _hoc_ghk,
 "modulationACh_cal13_ms", _hoc_modulationACh,
 "modulationDA_cal13_ms", _hoc_modulationDA,
 "rates_cal13_ms", _hoc_rates,
 0, 0
};
#define efun efun_cal13_ms
#define ghk ghk_cal13_ms
#define modulationACh modulationACh_cal13_ms
#define modulationDA modulationDA_cal13_ms
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 cal13_ms cal13_ms.mod\n");
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   ical = pbar * m * m * h * ghk ( _threadargscomma_ v , cali , calo ) * modulationDA ( _threadargs_ ) * modulationACh ( _threadargs_ ) ;
   }
 _current += ical;
...
#if NMODL_TEXT
static const char* nmodl_filename = "cal13_ms.mod";
static const char* nmodl_file_text = 
