...
#define nrn_init _nrn_init__caq_ms
#define _nrn_initial _nrn_initial__caq_ms
#define nrn_cur _nrn_cur__caq_ms
#define _nrn_current _nrn_current__caq_ms
#define nrn_jacob _nrn_jacob__caq_ms
#define nrn_state _nrn_state__caq_ms
#define _net_receive _net_receive__caq_ms 
#define rates rates__caq_ms 
#define states states__caq_ms 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_caq_ms", _hoc_setdata,
 "efun_caq_ms", _hoc_efun,
 "ghk_caq_ms", _hoc_ghk,
 "rates_caq_ms", _hoc_rates,
 0, 0
};
#define efun efun_caq_ms
#define ghk ghk_caq_ms
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 caq_ms caq_ms.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "caq_ms.mod";
static const char* nmodl_file_text = 
